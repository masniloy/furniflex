...
import logo3 from "../assets/FurniFlex1.png";
        ...
        <div className="min-h-screen flex items-center justify-center">
            <div className="flex flex-col md:flex-row items-center bg-white shadow-lg max-w-6xl w-full rounded-lg overflow-hidden">
                ...
                <div className="w-full md:w-1/2 p-10">
                    ...
                    <img className=" w-56 mx-auto m-5" src={logo3} alt="logo2" />
                    ...
                    {/* Sign In Button */}
                    <button className="btn bg-color1 text-white w-full mb-4">Sign Up</button>
                    ...
                    <div className="flex justify-center gap-4 mb-6">
                        <button className="btn w-1/2 btn-outline flex items-center justify-center">
                            <span className="mr-2">
                                <svg className="fill-current rounded-full p-2.5 h-10 w-10" viewBox="0 0 488 512">
                        ...
                        <button className="btn w-1/2 btn-outline flex items-center justify-center">
                            <span className="mr-2">
                                <svg className="fill-current rounded-full p-2.5 h-10 w-10" viewBox="0 0 320 512">
